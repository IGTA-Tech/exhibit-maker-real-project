...
function toDbFormat(job) {
  return {
    ...
    total_exhibits: job.totalExhibits,
    processed_exhibits: job.processedExhibits,
...
function fromDbFormat(record) {
  return {
    ...
    totalExhibits: record.total_exhibits,
    processedExhibits: record.processed_exhibits,
